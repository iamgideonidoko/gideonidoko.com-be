...
import { NewPost, NewPostComment, NewPostReply, PostUpdate } from '../interfaces/post.interface';
...
const updatePostSchema: JSONSchemaType<PostUpdate> = {
    type: 'object',
    properties: {
        title: { type: 'string', nullable: true },
        slug: { type: 'string', nullable: true },
        cover_img: { type: 'string', nullable: true },
...
export const updatePostAjvValidate = ajvInstance.compile(updatePostSchema);
